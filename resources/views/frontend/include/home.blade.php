                ...
                <div class="col-md-9 spldishes-grids">
                    ...
                    <div id="owl-demo" class="owl-carousel text-center agileinfo-gallery-row">
                        @foreach($dishes as $dish)
                            <a href="{{route('category_dish',$dish->category_id)}}" class="item g1">
                                <img class="lazyOwl" src="{{asset("upload/Dish/".$dish->dish_image)}}" style="height: 190px"
                                     width="158px" title="Our latest gallery" alt=""/>
